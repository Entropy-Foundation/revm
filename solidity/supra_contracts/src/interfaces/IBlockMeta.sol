...
interface IBlockMeta {
    ...
    function register(address _targetContract, bytes4 _selector) external;
    ...
    /// @dev Each entry must be packed as [target(160) | selector(32) | 0(64)].
    /// @param _executions Array of packed execution entries representing the new order.
